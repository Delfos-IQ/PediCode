...
export const DOSE_DRUGS = [
  {name:"Adrenalina",cat:"RCP",color:"#f87171",source:"BNFc 2020-21 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"Sin contraindicaciones absolutas en riesgo vital. Verificar dilución antes de administrar. Dosis de PCR (10 mcg/kg IV/IO) sin cambios respecto a guías previas — confirmada en ambas fuentes.",doses:[
  ...
  {name:"Amiodarona",cat:"RCP",color:"#fb923c",source:"BNFc 2020-21 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"⚠️ Prolonga QT. No mezclar con ningún otro fármaco. Bolo directo nunca < 3 min. Segunda dosis IV directa: esperar ≥ 15 min tras la primera.",doses:[
  ...
  {name:"Atropina",cat:"RCP",color:"#facc15",source:"BNFc 2020-21 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"Dosis mínima clásica (0,1 mg) ya NO se recomienda — puede causar bradicardia paradójica (Barrington 2011, Pediatrics). Dosis < 0,02 mg/kg pueden ser insuficientes. 20 mcg/kg confirmado en algoritmo de bradicardia de Notas de Bolso PT.",doses:[
  ...
  {name:"Adenosina",cat:"RCP",color:"#34d399",source:"BNFc 2020-21 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"⚠️ Usar acceso IV más proximal posible. Técnica de 2 jeringas. Dipiridamol potencia su efecto (contraindicado). Teofilina antagoniza su efecto. Escalada a 3ª dosis (0,3 mg/kg) según protocolo local portugués — no está en el esquema clásico PALS de 2 dosis.",doses:[
  ...
  {name:"Glucosa (SG10%)",cat:"RCP",color:"#a78bfa",source:"ERC PLS 2021 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"Indicada solo en hipoglucemia documentada (<45–50 mg/dL). Evitar hiperglucemia en PCR. ⚠️ Corrección: la dosis de 2 mL/kg es la dosis NEONATAL — en lactante/niño la dosis estándar es 5 mL/kg (0,5 g/kg).",doses:[
    {label:"Hipoglucemia — IV/IO (lactante/niño)",range:"5 mL/kg (SG 10%)",note:"= 0,5 g/kg · máx 25 mL · adolescente: 1 amp SG 20%",factor:5,unit:"mL",maxDose:25},
    {label:"Hipoglucemia — IV/IO (neonato)",range:"2 mL/kg (SG 10%)",note:"= 0,2 g/kg · dosis reducida para evitar hiperglucemia/oscilaciones",factor:2,unit:"mL",maxDose:10,neonatal:true},
  ]},
  {name:"Fentanilo",cat:"Sedo",color:"#c084fc",source:"BNFc 2020-21 · Handbook Drugs ICU 7ed · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Opioide sintético 100× más potente que morfina. Puede causar rigidez torácica con bolo rápido → administrar lento. Antagonista: naloxona. Rango de perfusión ampliado (0,05–5 mcg/kg/h) tras contrastar con Handbook of Drugs in ICU (1–5 mcg/kg/h para sedación) y Notas de Bolso PT.",doses:[
    {label:"Analgesia/sedación procedimiento — IV",range:"0,5–2 mcg/kg",note:"máx 100 mcg · bolo lento 2–3 min · repetir 0,5–1 mcg/kg cada 3 min",factor:1,unit:"mcg",maxDose:100},
    ...
    {label:"Perfusión analgesia/sedación UCI",range:"0,05–5 mcg/kg/h",note:"iniciar bajo y titular según respuesta · rango habitual de inicio 1 mcg/kg/h",factor:1,unit:"mcg/h",infusion:true},
  ...
  {name:"Morfina",cat:"Sedo",color:"#818cf8",source:"BNFc 2020-21 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Opioide prototipo. ⚠️ Neonatos y lactantes <3m: mayor riesgo de depresión respiratoria. Contraindicado en TCE con HTIC, broncoespasmo grave, íleo paralítico. Postoperatorio no ventilado: bolo 0,05–0,1 mg/kg/dosis c/4–6h (adolescente iniciar 2–3 mg, máx habitual 5 mg/dosis) — Notas de Bolso PT.",doses:[
    ...
    {label:"Perfusión posoperatoria/UCI",range:"0,005–0,04 mg/kg/h",note:"en ventilación espontánea (no intubado) máx 0,03 mg/kg/h por riesgo de depresión respiratoria",factor:0.02,unit:"mg/h",infusion:true},
  ...
  {name:"Ketamina",cat:"Sedo",color:"#f472b6",source:"BNFc 2020-21 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Anestesia disociativa: mantiene reflejos, no deprime respiración (en dosis habituales). ⚠️ CI: <3 meses, HTIC, glaucoma o lesiones oculares, hipertensión no controlada, porfiria, cardiopatía grave. Puede causar laringoespasmo. Asociar midazolam si riesgo de reacciones disfóricas.",doses:[
  ...
  {name:"Midazolam",cat:"Sedo",color:"#34d399",source:"BNFc 2020-21 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"⚠️ <6 meses: mayor riesgo de depresión respiratoria — titular en pequeños incrementos. Potencia efecto de otros depresores del SNC. CYP3A4: eritromicina y antifúngicos azólicos potencian su efecto. Antagonista: flumazenil. Perfusión ampliada a 0,05–0,4 mg/kg/h (tabla de sedoanalgesia, Notas de Bolso PT); en status epiléptico refractario se han usado dosis de hasta 0,6–1,2 mg/kg/h bajo supervisión especializada.",doses:[
    ...
    {label:"Sedación VM — Perfusión continua",range:"0,05–0,4 mg/kg/h",note:"iniciar bajo (0,05–0,1) y titular según escala de sedación (COMFORT/Ramsay)",factor:0.1,unit:"mg/h",infusion:true},
  ]},
  {name:"Diazepam",cat:"Sedo",color:"#4ade80",source:"Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Vida media larga (20–100h + metabolito activo) → no es fármaco de 1ª elección para sedación de procedimientos. Preferir midazolam. Indicado como anticonvulsivante rectal extrahospitalario. ⚠️ No recomendado <6 meses. Excipientes: contiene propilenglicol, benzoato sódico y alcohol bencílico — precaución en neonatos.",doses:[
    {label:"Crisis convulsiva — IV",range:"0,2–0,5 mg/kg",note:"máx 10 mg · lento 3–5 min · repetir a los 5–10 min si precisa (Notas de Bolso PT)",factor:0.3,unit:"mg",maxDose:10},
  ...
  {name:"Propofol",cat:"Sedo",color:"#fbbf24",source:"BNFc 2020-21 · Handbook Drugs ICU 7ed",rev:"2026-09",status:"verified",notes:"⚠️ CI absoluta: sedación continua en UCI en <16 años — riesgo de Síndrome de Infusión de Propofol (PRIS), potencialmente mortal (BNFc, Handbook ICU). No usar en <1 mes. Alergia al huevo/soja: consultar ficha. Dolor en la inyección: usar vena grande o lidocaína 0,5 mg/kg previa. Personal entrenado con capacidad de manejo de vía aérea. ⚠️ Corrección: el rango de perfusión se ha limitado a 4 mg/kg/h — dosis mayores mantenidas se asocian a PRIS (BNFc, Handbook ICU); la perfusión es solo para sedación/anestesia de corta duración, NUNCA para sedación prolongada en UCI en <16 años.",doses:[
    {label:"Inducción anestesia/sedación profunda — IV",range:"1–2 mg/kg",note:"bolo IV · edad >1 mes · máx primera dosis 100 mg · (anestesia formal en quirófano: BNFc indica 2,5–4 mg/kg)",factor:1.5,unit:"mg",maxDose:100},
    {label:"Sedación corta duración — Perfusión",range:"0,5–4 mg/kg/h",note:"⚠️ NO usar para sedación prolongada en UCI en <16 años · no superar 4 mg/kg/h (riesgo PRIS)",factor:2,unit:"mg/h",maxDose:4,infusion:true},
  ...
  {name:"Paracetamol IV",cat:"Sedo",color:"#a3e635",source:"BNFc 2020-21 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Analgésico/antipirético de 1ª línea. Buen perfil de seguridad incluso en neonatos si se respeta la dosis. Dosis diaria máxima = 60 mg/kg/día (niños) o 4 g/día (adultos). Intervalo mínimo 4h entre dosis.",doses:[
  ...
  {name:"Rocuronio",cat:"BNM",color:"#60a5fa",source:"Notas de Bolso PT · BNFc 2020-21",rev:"2026-09",status:"verified",notes:"BNM no despolarizante de inicio rápido. Uso IV exclusivamente. ⚠️ Reversión con SUGAMADEX. En ISR: 1–1,2 mg/kg → inicio 60 seg. Inicio más lento en neonatos. Duración varía según temperatura, pH, fármacos concomitantes. Dosis confirmadas frente a tabla de BNM de Notas de Bolso PT (0,6–1,2 mg/kg).",doses:[
  ...
  {name:"Lidocaína",cat:"Cardio",color:"#0ea5e9",source:"BNFc 2020-21 · Handbook Drugs ICU 7ed",rev:"2026-09",status:"verified",notes:"⚠️ Toxicidad (parestesias, tinnitus, convulsiones, arritmias) con velocidad de infusión excesiva. Velocidad máx IV: 0,7 mg/kg/min. Amiodarona puede reducir su metabolismo. CI: síndrome de Wolf-Parkinson-White, bloqueo AV o intraventricular sin marcapasos, disfunción sinusal grave.",doses:[
  ...
  {name:"Aminofilina",cat:"Resp",color:"#f97316",source:"Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"3ª línea en asma grave — solo si no hay respuesta a salbutamol + sulfato Mg. Índice terapéutico estrecho (5–15 mcg/mL). ⚠️ Monitorizar niveles: toxicidad a >20 mcg/mL (náuseas, arritmias, convulsiones). Múltiples interacciones (eritromicina, quinolonas, cimetidina aumentan niveles). No usar si ya recibe teofilina oral. Ajustar en fumadores (aclaramiento aumentado). Dosis de carga (5–6 mg/kg en 30 min) confirmada frente a Notas de Bolso PT (perfusión de mantenimiento general ~1 mg/kg/h, consistente con el desglose por edad ya usado aquí).",doses:[
  ...
  {name:"Flumazenil",cat:"Antídoto",color:"#f59e0b",source:"BNFc 2020-21",rev:"2026-09",status:"verified",notes:"⚠️ Vida media MUY corta (30–60 min) — mucho menor que la mayoría de BZD. Riesgo de resedación → monitorizar. CI: pacientes con BZD por HTIC o estatus epiléptico (puede precipitar convulsiones). CI en intoxicaciones mixtas BZD + antidepresivos tricíclicos. Ajustar dosis en IH (espaciar bolos).",doses:[
  ...
  {name:"Sugamadex",cat:"Antídoto",color:"#06b6d4",source:"BNFc 2020-21 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Agente encapsulante selectivo de rocuronio (y vecuronio). Reversión inmediata e independiente del tiempo. No requiere neostigmina ni atropina. ⚠️ En emergencia (PCR con rocuronio): usar dosis 16 mg/kg sin esperar monitorización TOF. En IR grave (ClCr <30): no recomendado — puede reacumularse.",doses:[
  ...
  {name:"Atropina (organofosf.)",cat:"Antídoto",color:"#fb923c",source:"Notas de Bolso PT · BNFc 2020-21",rev:"2026-09",status:"verified",notes:"Indicación: intoxicación por organofosforados o carbamatos (anticolinesterásicos). Objetivo: secar secreciones bronquiales (NO FC ni midriasis). En intoxicación grave: requiere dosis muy altas, repetidas cada 5–10 min hasta que cesen las secreciones. Complementar con pralidoxima si disponible (<24h de exposición). No usar pralidoxima en carbamatos.",doses:[
  ...
  {name:"Metilprednisolona",cat:"Otros",color:"#e879f9",source:"BNFc 2020-21",rev:"2026-09",status:"verified",notes:"Corticoide de referencia en asma grave, lupus, MIS-C, trasplante, enfermedades autoinmunes. Pulso de metilprednisolona (30 mg/kg) indicado en esclerosis múltiple, nefritis grave, rechazo agudo. Monitorizar glucemia, PA y K⁺ con dosis altas.",doses:[
  ...
  {name:"Ácido Tranexámico",cat:"Otros",color:"#f43f5e",source:"Notas de Bolso PT · Pediamécum AEP",rev:"2026-09",status:"verified",notes:"Antifibrinolítico. Indicación principal: hemorragia traumática grave (máx eficacia si <3h del traumatismo). ⚠️ CI: IR grave, historia de trombosis arterial o venosa, CID, historia de convulsiones (puede ser proconvulsivante). Vigilar: trastornos visuales en tratamiento prolongado.",doses:[
    ...
    {label:"Hemorragia postoperatoria / ECMO — IV",range:"10–15 mg/kg/8h",note:"protocolo de sangrado postquirúrgico/ECMO (Notas de Bolso PT)",factor:12,unit:"mg"},
  ]},

  // ── ANTIBIÓTICOS ─────────────────────────────────────────────────────────
  {name:"Amoxicilina-Clavulánico",cat:"ATB",color:"#10b981",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"CI: penicilinas (hipersensibilidad tipo I cruzada con cefalosporinas ~1–2%). ⚠️ Ajustar en IR. Hepatotoxicidad colestásica: más frecuente en adultos, rara en niños. Usar el componente amoxicilina como referencia de dosis; elegir presentación con proporción adecuada.",doses:[
  ...
  {name:"Cefotaxima",cat:"ATB",color:"#0891b2",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"Cefalosporina 3ª generación. Primera línea en meningitis bacteriana pediátrica, sepsis y neumonía grave (junto a ampicilina en <3 meses). Buena penetración en LCR. CI: hipersensibilidad a cefalosporinas. Ajustar en IR grave.",doses:[
  ...
  {name:"Ceftriaxona",cat:"ATB",color:"#2563eb",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"⚠️ CONTRAINDICADO en neonatos <28 días (cualquier vía) y en pacientes con hiperbilirrubinemia, hipoalbuminemia o que reciben calcio IV. Precipita con calcio → NO mezclar en el mismo equipo. CI en hipersensibilidad a cefalosporinas. Puede causar colelitiasis reversible (pseudolitiasis biliar).",doses:[
  ...
  {name:"Meropenem",cat:"ATB",color:"#7c3aed",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"Carbapenem de amplio espectro. Indicado en infecciones graves por gérmenes multirresistentes, sepsis nosocomial y meningitis por P. aeruginosa. CI: hipersensibilidad a carbapenems. Vigilar: convulsiones (raro, más frecuente con imipenem). ⚠️ Los carbapenems reducen niveles de valproato — monitorizar.",doses:[
  ...
  {name:"Piperacilina-Tazobactam",cat:"ATB",color:"#6d28d9",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"CI: hipersensibilidad a penicilinas (usar con precaución en alergia a cefalosporinas). ⚠️ Puede producir hipopotasemia en tto prolongado. Ajustar en IR. Dosis referenciadas al componente piperacilina. Alta actividad frente a Pseudomonas y anaerobios.",doses:[
  ...
  {name:"Gentamicina",cat:"ATB",color:"#b45309",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"Aminoglucósido. Dosis única diaria (DUD): mejor eficacia y menor nefrotoxicidad. ⚠️ Monitorizar niveles: valle <1 mcg/mL (idealmente indetectable); pico 8–12 mcg/mL. Nefrotóxico y ototóxico — evitar en IR; hidratación adecuada. Potencia el bloqueo neuromuscular. En FQ y endocarditis: ver esquema específico.",doses:[
  ...
  {name:"Metronidazol",cat:"ATB",color:"#78350f",source:"Pediamécum AEP · BNFc 2020-21 (revisión cruzada sin discrepancias significativas)",rev:"2026-09",status:"verified",notes:"Activo frente a anaerobios y protozoos. Indicado en infecciones abdominales, colitis por C. difficile, infecciones por Bacteroides y G. lamblia. ⚠️ Efecto antabús con alcohol. Potencia el anticoagulante de cumarinas. Ajustar en IR/IH graves. CI: 1er trimestre embarazo.",doses:[
  ...
  {name:"Clonidina",cat:"Sedo",color:"#818cf8",source:"BNFc 2020-21",rev:"2026-09",status:"verified",notes:"Agonista α₂. Sedación, analgesia coadyuvante, síndrome de abstinencia (NOWS). Evitar retirada brusca (HTA rebote). Bradicardia e hipotensión como efectos adversos principales.",doses:[
  ...
  // ── BNM additions ─────────────────────────────────────────────────────
  {name:"Cisatracurio",cat:"BNM",color:"#a78bfa",source:"Notas de Bolso PT · BNFc 2020-21",rev:"2026-09",status:"verified",notes:"BNM no despolarizante. No libera histamina. Eliminación de Hofmann (independiente de función renal/hepática). Primera elección en UCI para BNM prolongado. Monitorizar con TOF. Dosis de intubación y perfusión confirmadas frente a Notas de Bolso PT (0,1–0,15 mg/kg intubación · 0,1–0,2 mg/kg/h perfusión).",doses:[
  ...
  {name:"Manitol 20%",cat:"Otros",color:"#93c5fd",source:"Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Añadido en revisión 2026 — diurético osmótico de 1ª línea en hipertensión intracraneal (TCE, ACV, tumor, hidrocefalia). ⚠️ Evitar en hipovolemia/hipotensión no corregida e insuficiencia renal grave. Monitorizar osmolaridad sérica (objetivo <320 mOsm/L) y diuresis.",doses:[
    {label:"Hipertensión intracraneal — IV",range:"0,3 g/kg (1,5 mL/kg sol. 20%)",note:"infundir en 15–20 min · puede repetir cada 6–8h según PIC",factor:1.5,unit:"mL"},
  ]},
  {name:"Suero Salino Hipertónico 3%",cat:"Otros",color:"#60a5fa",source:"Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Añadido en revisión 2026 — alternativa/complemento a manitol en hipertensión intracraneal, de elección si hipovolemia asociada. Objetivo Na⁺ sérico 145–155 mEq/L. Vía central preferible en perfusión prolongada. Monitorizar natremia con frecuencia (riesgo de mielinolisis pontina si corrección demasiado rápida).",doses:[
    {label:"Hipertensión intracraneal — Bolo IV",range:"6 mL/kg (NaCl 3%)",note:"infundir en 10–20 min",factor:6,unit:"mL"},
    {label:"Hipertensión intracraneal — Perfusión IV",range:"0,1–1 mL/kg/h (NaCl 3%)",note:"titular según PIC/natremia",factor:0.5,unit:"mL/h",infusion:true},
  ]},
