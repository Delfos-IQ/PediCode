...
export const DOSE_DRUGS = [
  ...
  {name:"Amiodarona",cat:"RCP",color:"#fb923c",source:"BNFc 2025-26 · Notas de Bolso PT 2015",rev:"2026-09",status:"verified",notes:"⚠️ Prolonga QT. No mezclar con ningún otro fármaco. Bolo directo nunca < 3 min. Segunda dosis IV directa: esperar ≥ 15 min tras la primera.",doses:[
  ...
  {name:"Fentanilo",cat:"Sedo",color:"#c084fc",source:"BNFc 2025-26 · Handbook Drugs ICU 7ed · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Opioide sintético 100× más potente que morfina. Puede causar rigidez torácica con bolo rápido → administrar lento. Antagonista: naloxona. Rango de perfusión ampliado (0,05–5 mcg/kg/h) tras contrastar con Handbook of Drugs in ICU (1–5 mcg/kg/h para sedación) y Notas de Bolso PT.",doses:[
  ...
  {name:"Morfina",cat:"Sedo",color:"#818cf8",source:"BNFc 2025-26 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Opioide prototipo. ⚠️ Neonatos y lactantes <3m: mayor riesgo de depresión respiratoria. Contraindicado en TCE con HTIC, broncoespasmo grave, íleo paralítico. Postoperatorio no ventilado: bolo 0,05–0,1 mg/kg/dosis c/4–6h (adolescente iniciar 2–3 mg, máx habitual 5 mg/dosis) — Notas de Bolso PT.",doses:[
  ...
  {name:"Ketamina",cat:"Sedo",color:"#f472b6",source:"BNFc 2025-26 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Anestesia disociativa: mantiene reflejos, no deprime respiración (en dosis habituales). ⚠️ CI: <3 meses, HTIC, glaucoma o lesiones oculares, hipertensión no controlada, porfiria, cardiopatía grave. Puede causar laringoespasmo. Asociar midazolam si riesgo de reacciones disfóricas.",doses:[
  ...
  {name:"Midazolam",cat:"Sedo",color:"#34d399",source:"BNFc 2025-26 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"⚠️ <6 meses: mayor riesgo de depresión respiratoria — titular en pequeños incrementos. Potencia efecto de otros depresores del SNC. CYP3A4: eritromicina y antifúngicos azólicos potencian su efecto. Antagonista: flumazenil. Perfusión ampliada a 0,05–0,4 mg/kg/h (tabla de sedoanalgesia, Notas de Bolso PT); en status epiléptico refractario se han usado dosis de hasta 0,6–1,2 mg/kg/h bajo supervisión especializada.",doses:[
  ...
  {name:"Propofol",cat:"Sedo",color:"#fbbf24",source:"BNFc 2025-26 · Handbook Drugs ICU 7ed",rev:"2026-09",status:"verified",notes:"⚠️ CI absoluta: sedación continua en UCI en <16 años — riesgo de Síndrome de Infusión de Propofol (PRIS), potencialmente mortal (BNFc, Handbook ICU). No usar en <1 mes. Alergia al huevo/soja: consultar ficha. Dolor en la inyección: usar vena grande o lidocaína 0,5 mg/kg previa. Personal entrenado con capacidad de manejo de vía aérea. ⚠️ Corrección: el rango de perfusión se ha limitado a 4 mg/kg/h — dosis mayores mantenidas se asocian a PRIS (BNFc, Handbook ICU); la perfusión es solo para sedación/anestesia de corta duración, NUNCA para sedación prolongada en UCI en <16 años.",doses:[
  ...
  {name:"Paracetamol IV",cat:"Sedo",color:"#a3e635",source:"BNFc 2025-26 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Analgésico/antipirético de 1ª línea. Buen perfil de seguridad incluso en neonatos si se respeta la dosis. Dosis diaria máxima = 60 mg/kg/día (niños) o 4 g/día (adultos). Intervalo mínimo 4h entre dosis.",doses:[
  ...
  {name:"Lidocaína",cat:"Cardio",color:"#0ea5e9",source:"BNFc 2025-26 · Handbook Drugs ICU 7ed",rev:"2026-09",status:"verified",notes:"⚠️ Toxicidad (parestesias, tinnitus, convulsiones, arritmias) con velocidad de infusión excesiva. Velocidad máx IV: 0,7 mg/kg/min. Amiodarona puede reducir su metabolismo. CI: síndrome de Wolf-Parkinson-White, bloqueo AV o intraventricular sin marcapasos, disfunción sinusal grave.",doses:[
  ...
  {name:"Flumazenil",cat:"Antídoto",color:"#f59e0b",source:"BNFc 2025-26",rev:"2026-09",status:"verified",notes:"⚠️ Vida media MUY corta (30–60 min) — mucho menor que la mayoría de BZD. Riesgo de resedación → monitorizar. CI: pacientes con BZD por HTIC o estatus epiléptico (puede precipitar convulsiones). CI en intoxicaciones mixtas BZD + antidepresivos tricíclicos. Ajustar dosis en IH (espaciar bolos).",doses:[
  ...
  {name:"Sugamadex",cat:"Antídoto",color:"#06b6d4",source:"BNFc 2025-26 · Notas de Bolso PT",rev:"2026-09",status:"verified",notes:"Agente encapsulante selectivo de rocuronio (y vecuronio). Reversión inmediata e independiente del tiempo. No requiere neostigmina ni atropina. ⚠️ En emergencia (PCR con rocuronio): usar dosis 16 mg/kg sin esperar monitorización TOF. En IR grave (ClCr <30): no recomendado — puede reacumularse.",doses:[
  ...
  {name:"Metilprednisolona",cat:"Otros",color:"#e879f9",source:"BNFc 2025-26",rev:"2026-09",status:"verified",notes:"Corticoide de referencia en asma grave, lupus, MIS-C, trasplante, enfermedades autoinmunes. Pulso de metilprednisolona (30 mg/kg) indicado en esclerosis múltiple, nefritis grave, rechazo agudo. Monitorizar glucemia, PA y K⁺ con dosis altas.",doses:[
  ...
  {name:"Clonidina",cat:"Sedo",color:"#818cf8",source:"BNFc 2025-26",rev:"2026-09",status:"verified",notes:"Agonista α₂. Sedación, analgesia coadyuvante, síndrome de abstinencia (NOWS). Evitar retirada brusca (HTA rebote). Bradicardia e hipotensión como efectos adversos principales.",doses:[
  ...
  // ── Nuevos Cardio ─────────────────────────────────────────────────────
  {name:"Hidralazina IV",cat:"Cardio",color:"#f472b6",source:"Pediamécum AEP · AAP HTA Pediátrica 2017",rev:"2026-03",status:"verified",notes:"Vasodilatador arterial directo. Urgencias hipertensivas con manifestaciones neurológicas/renales. Inicio acción 10–20 min. Taquicardia refleja — asociar betabloqueante. ⚠️ Lupus inducido en uso crónico (raro en agudo).",doses:[
  ...
  {name:"Nifedipino",cat:"Cardio",color:"#fbbf24",source:"Pediamécum AEP · AAP HTA Pediátrica 2017",rev:"2026-03",status:"verified",notes:"BCC dihidropiridínico. Urgencia HTA sin lesión orgánica (cápsula VO). ⚠️ Vía sublingual DESACONSEJADA (bajadas bruscas e impredecibles). Usar cápsula masticada VO. Inicio 15–30 min. CI: estenosis aórtica grave.",doses:[
  ...
  // ── Nuevos Resp ───────────────────────────────────────────────────────
  {name:"Terbutalina IV/SC",cat:"Resp",color:"#22d3ee",source:"Pediamécum AEP · GEMA 5.5",rev:"2026-03",status:"verified",notes:"β₂ agonista. Crisis asmática grave-muy grave si no responde a vía inhalada. Monitorización cardiaca continua (riesgo hipopotasemia, taquicardia, HTA). SC si no hay acceso IV inmediato.",doses:[
